public class Funcionario {
    ...
    private double salarioHoraMinimo = 12.5;
    ...
    public Funcionario clone() {
        Funcionario novoFunc  = new Funcionario(this.nome, this.salarioHora);
        novoFunc.horasTrabalhadasMes = this.horasTrabalhadasMes;
        return novoFunc;
    }

    public boolean equals(Funcionario compare) {
        if(this.nome.equals(compare.nome) && (this.salarioHora == compare.salarioHora)) {
            return true;
        }
        else return false;
    }
